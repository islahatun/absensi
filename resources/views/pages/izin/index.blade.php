                        ...
                        <div class="card">
                            ...
                            <form id="formJurusan" action="" method="method">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="catgory_name">Tanggal Pengajuan Izin</label>
                                        <input type="date" id="date_permission" name="date_permission" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">Latlon In</label>
                                        <select id="is_approval" name="is_approval" class="form-control">
            ...
            Swal
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('izin.destroy', ':id') }}".replace(':id', data.id),
                            type: "DELETE",
                            cache: false,
                            data: {
                                "_token": "{{ csrf_token() }}"

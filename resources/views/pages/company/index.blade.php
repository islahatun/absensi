                            ...
                            <form id="formJurusan" action="" method="method">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="catgory_name">Nama Perusahaan</label>
                                        <input type="text" id="name" name="name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">E- Mail Perusahaan</label>
                                        <input type="text" id="email" name="email" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">Alamat Perusahaan</label>
                                        <input type="text" id="address" name="address" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">Latitude</label>
                                        <input type="text" id="latitude" name="latitude" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">Longitude</label>
                                        <input type="text" id="longitude" name="longitude" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="catgory_name">Radius</label>
                                        <input type="text" id="radius_km" name="radius_km" class="form-control">
                                    </div>
                                    <div class="form-group">
                            ...
                            Swal
                                ...
                                .then((result) => {
                                    if (result.isConfirmed) {
                                        $.ajax({
                                            url:  "{{ route('company.destroy', ':id') }}".replace(':id', data.id),
                                            type: "DELETE",
                                            cache: false,
                                            data: {
                                                "_token": "{{ csrf_token() }}"
